export enum Message {
  ...
  wrongParameters = "Wrong input parameters, kindly check and try again",
  ...
  beneficiaryExists = "Beneficiary already added.",
  beneficiaryToAddNotActive = "Beneficiary you are trying to add is not active.",
  beneficiariesFetched = "Beneficiaries fetched successfully.",
  beneficiaryDeleted = "Beneficiary deleted successfully.",
  beneficiaryAdded = "Beneficiary added successfully.",
  beneficiaryFetched = "Beneficiary fetched successfully.",
  beneficiaryNotExists = "Beneficiary does not exists.",
  totalReachNotFound = "Total reach not found.",
  totalReachFetched = "Total reach fetched successfully.",
  afflilationExists = "Affiliation data already exists.",
  affiliateCodeGenerated = "Affiliate code generated successfully.",
  affiliateCodeAlreadyGenerated = "Affiliate code already generated.",
  affiliatesFetched = "Affiliates fetched successfully.",
  affiliatesTransactionsFetched = "Affiliates transactions fetched successfully.",
  totalAffiliatesFetched = "Total affiliates fetched successfully.",
  bankListFetched = "Bank list fetched successfully.",
  bankDetailsFetched = "Bank details fetched successfully.",
  transferInitialized = "Transfer initialized successfully.",
  invalidTransactionPin = "Invalid transaction pin.",
  noAccountSpecified = "Account to withdraw from is not specified.",
  insufficientBalance = "Insufficient balance to complete this transaction.",
  futureWealthAdded = "FutureWealth added successfully.",
  futureWealthFetched = "FutureWealth fetched successfully.",
  subsidiaryExists = "Subsidiary already added.",
  subsidiaryToAddNotActive = "Subsidiary you are trying to add is not active.",
  subsidiariesFetched = "Subsidiaries fetched successfully.",
  subsidiaryDeleted = "Subsidiary deleted successfully.",
  subsidiaryAdded = "Subsidiary added successfully.",
  subsidiaryUpdated = "Subsidiary updated successfully.",
  subsidiaryFetched = "Subsidiary fetched successfully.",
  subsidiaryNotExists = "Subsidiary does not exists.",
}
